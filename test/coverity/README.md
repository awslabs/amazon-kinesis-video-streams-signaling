# Static code analysis for SIGNALING Library
This directory is made for the purpose of statically analyzing the SIGNALING Library using
...
3. Download the repo including the submodules using the following commands:
    - `git clone --recurse-submodules https://github.com/awslabs/amazon-kinesis-video-streams-signaling`
    - `cd ./amazon-kinesis-video-streams-signaling`
